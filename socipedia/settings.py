...
https://docs.djangoproje# Load Auth0 application settings into memory
...
AUTH0_CLIENT_SECRET = os.environ.get("AUTH0_CLIENT_SECRET", "FcnjVjiWpDvLpF4AnZGEBQGOxsz8_yMb95jO_MpA45FDdv3-fxCh4ZBEU4-IBwXI")om/en/5.2/topics/settings/
